...
const data = [{
    name: 'Learn at Home', descriptionOne: 'learn at your best convenience from home or at a place of your work.', descriptionTwo: 'Get a full experience of a classroom from wherever you are.',image: '<img src="./img/elizeu-dias-2EGNqazbAMk-unsplash.jpg" alt="">',
  },
  {
    name: 'Meet new People', descriptionOne: 'Meet new people who reside from all over the world and get a diversified knowledge about different cultures.', descriptionTwo: 'Build your resume by working and learning with people from all kinds of cultures and religions.',image: './img/linkedin-sales-solutions-jJFrkJP_-RA-unsplash.jpg',
  },
  {
    name: 'Get full time Support', descriptionOne: 'get full-time support from our skilled technical and non-technical staff members.', descriptionTwo: 'get access to our support team 24/7.',image: './img/brooke-cagle-TxSVqNgnjq4-unsplash.jpg',
  },
  {
    name: 'Collaborate', descriptionOne: 'Work and learn in collaboration with students from all over the world.', descriptionTwo: 'get collaboration experience with people from different cultures.',image: './img/muhammad-faiz-zulkeflee-alw-CwGFmwQ-unsplash.jpg',
  },
  {
    name: 'Work as an Intern', descriptionOne: 'Work as an intern in well-known technological companies from all over the world!', descriptionTwo: 'Get the best experience of your life as a developer by working with companies like Facebook and Google.',image: './img/ryan-hoffman-ijhzqAm3N1Y-unsplash.jpg',
  },
  {
    name: 'Graduate', descriptionOne: 'Graduate with a well-accepted and respected certificate in software development.', descriptionTwo: 'As you are well equipped with the necessary knowledge you need to become a software developer go out and start looking for your dream job.',image: 'pic1.png',
  }];
...
for (let x = 0; x < 2; x += 1) {
    output.innerHTML = `${output.innerHTML}<div class="feature_wrapper" id="feature_mobile">
    <div class="feature_div">
                <div class="dotted_wrapper">
                    <img class="background_wrapper" src="${data[x].image}">
                    <div class="dotted_background"></div>
                </div>
                <div class="feature-txt_wrapper">
                    <h1 class="feature_title">${data[x].name}</h1>
                    <p class="feature_main-one">${data[x].descriptionOne}</p>
                    <div class="feature_underline"></div>
                    <p class="feature_main-two">${data[x].descriptionTwo}</p>
                </div>
            </div>
